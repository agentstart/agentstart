...
SEARCHABLE: tool schema, tool types, chat tools, zod schemas
    ...
    metadata: z
      .object({
        appliedEdits: z
          ...
          .optional(),
        filePath: z.string().optional(),
        totalEdits: z.number().optional(),
        totalReplacements: z.number().optional(),
        failedEditIndex: z.number().optional(),
        commitHash: z.string().optional(),
      })
      .optional(),
  }),
...
export type AgentStackToolInput = z.infer<typeof toolInputSchema>;
export type AgentStackToolOutput = z.infer<typeof toolOutputSchema>;
export type AgentStackToolSet = InferUITools<ReturnType<typeof agentTools>>;
export type AgentStackMessagePart = UIMessagePart<
  AgentStackDataPart,
  AgentStackToolSet
>;
