...
AGENT: Memory adapter schema normalizer
...
SEARCHABLE: memory adapter schema, normalize tables, getSchema
agent-frontmatter:end */

import type { AgentStartOptions, FieldAttribute } from "@agentstart/types";
import { getTables } from ".";

export function getSchema(config: Omit<AgentStartOptions, "agent">): Record<
  string,
  {
    modelName: string;
