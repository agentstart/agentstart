...
PURPOSE: Define schema field structures shared across database adapters
USAGE: import type { FieldAttribute } from "@agentstart/types"
...
FEATURES:
  - Captures shared metadata for adapter field configuration
  - Enables type inference for input/output payloads
SEARCHABLE: field attribute types, schema metadata, adapter field inference
