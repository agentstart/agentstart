...
AGENT: Database adapter shared utilities
...
SEARCHABLE: packages, agentstart, src, db, adapter, shared, utilities, validation
agent-frontmatter:end */

import { AgentStartError } from "@agentstart/utils";
import type { AdapterDbSchema } from "@/db/get-tables";

// Type aliases for better readability
type Tables = AdapterDbSchema;
