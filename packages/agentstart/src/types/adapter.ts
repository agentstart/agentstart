...
USAGE: import type { Adapter, AgentStartOptions } from "agentstart"
EXPORTS: Adapter, AdapterInstance, AgentStartOptions, SecondaryStorage, User, Thread, Account, Verification, Where
FEATURES:
  - Defines the adapter contract consumed by Agent Start adapters
  - Provides a pared-down AgentStartOptions without plugin hooks
  - Includes shared record models used in adapter tests
SEARCHABLE: adapter types, agent start options, database models
...
export type AdapterInstance = (options: AgentStartOptions) => Adapter;
