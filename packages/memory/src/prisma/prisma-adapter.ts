...
PURPOSE: Implements the Prisma memory adapter translating AgentStart operations into Prisma queries.
USAGE: Provide a Prisma client to persist agent data through Prisma ORM.
EXPORTS: PrismaConfig, prismaMemoryAdapter
FEATURES:
  - Transforms agent filters into Prisma where clauses
  - Handles pagination and ordering for memory retrieval
SEARCHABLE: packages, agentstart, src, memory, adapter, prisma, persistence
...
export const prismaMemoryAdapter =
