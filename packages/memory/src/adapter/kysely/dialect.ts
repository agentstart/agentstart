...
SEARCHABLE: packages, agentstart, src, memory, adapter, kysely, dialect, database
agent-frontmatter:end */

import type { AgentStartOptions, KyselyDatabaseType } from "@agentstart/types";
import {
  type Dialect,
  Kysely,
  MssqlDialect,
