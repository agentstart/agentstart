...
USAGE: Import metadataSchema and AgentStackMetadata for message metadata typing
EXPORTS: metadataSchema, AgentStackMetadata
FEATURES:
...
export type AgentStackMetadata = z.infer<typeof metadataSchema>;
