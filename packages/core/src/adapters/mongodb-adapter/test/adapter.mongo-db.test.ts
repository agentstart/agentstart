...
FEATURES:
  ...
  - Ensures project/chat/message behaviour matches expectations
SEARCHABLE: mongodb adapter test, project chat message
...
const connection = await (async () => {
  try {
    const db = await createDb("mongodb://127.0.0.1:27017", "agent-stack-tests");
