...
export function Logo({ className, background = false }: LogoProps) {
  ...
  const fillBackgroundColor = useMemo(() => {
    if (resolvedTheme === "dark") {
      return "white";
    }
    return "black";
