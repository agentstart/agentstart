...
The conversation focuses on smooth playback of streamed responses:

- **Sticky scroll** - Keeps the latest assistant message in view while streaming
- **Message memoization** - Prevents unnecessary re-renders as new parts arrive
- **Incremental fetching** - Loads message history when the component mounts
