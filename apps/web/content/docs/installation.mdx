...
<Tabs items={["sqlite", "postgres", "mysql", "mongodb"]}>
  <Tab value="sqlite">
    ...
    export const start = agentStart({
      agent,
      memory: drizzleAdapter(db, { provider: "sqlite", schema }),
    });
    ```
  </Tab>
  <Tab value="postgres">
    ...
    export const start = agentStart({
      agent,
      memory: kyselyAdapter(db, { type: "postgres" }),
    });
    ```
  </Tab>
  <Tab value="mysql">
    ...
    export const start = agentStart({
      agent,
      memory: prismaAdapter(prisma, { provider: "mysql" }),
    });
    ```
  </Tab>
  <Tab value="mongodb">
    ...
    export const start = agentStart({
      agent,
      memory: mongodbAdapter(client.db("agentstart")),
    });
    ```
  </Tab>
</Tabs>
