...
import { GenerateVerificationCode } from "@/components/agent/tools/generate-verification-code";
...
export const MessagePart = memo<Props>(({ part, isStreaming }) => {
  switch (part.type) {
    ...
    case "tool-generateVerificationCode":
      return <GenerateVerificationCode part={part} />;
